...
import { User, Download, Trash2, CheckCircle, Clock, FileDown, Mail } from 'lucide-react'
import {
  Button,
  StatusBadge,
  EmptyState,
...
export default function MyDataPage() {
  ...
  const requestDelete = () => {
    ...
    addToast('Solicitação de exclusão enviada. Você receberá um email de confirmação.', 'success')
  }
    ...
    <div className="min-h-screen bg-surface-base">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <ConfirmDialog
          ...
          description="Você está prestes a solicitar a exclusão permanente de todos os seus dados pessoais. Esta ação é irreversível."
          confirmText="Confirmar Exclusão"
          cancelText="Cancelar"
          variant="danger"
        >
          <ul className="text-sm text-text-muted mb-2 space-y-1">
