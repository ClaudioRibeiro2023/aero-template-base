    ...
    <div className="min-h-screen bg-surface-base">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-medium text-text-primary">{log.sourceName}</span>
                  ...
                  <div className="flex items-center gap-4 text-xs">
                    ...
                    {log.duration && <span className="text-text-muted">⏱ {log.duration}</span>}
                  </div>
                </button>
              )
            })}
          ...
          <div>
            {selectedLog ? (
              <div className="bg-surface-elevated rounded-lg border border-border-default p-6 sticky top-6">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-bold text-text-primary">{selectedLog.sourceName}</h2>
                  <button
                    type="button"
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div className="p-3 bg-surface-muted rounded text-center">
              ...
              <div className="bg-surface-elevated rounded-lg border border-border-default p-12 text-center sticky top-6">
                <History size={48} className="mx-auto mb-4 text-text-muted" />
                <p className="text-text-muted">Selecione um log para ver detalhes</p>
              </div>
            )}
          </div>
        </div>
